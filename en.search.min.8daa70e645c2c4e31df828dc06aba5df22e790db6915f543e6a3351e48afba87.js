...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.555d3187b0469afa876307fc9b5ba0da2064f2f34d0ffb94cd75a7fe35f532ed.js',function(){input.required=false;search();});}
